...
import com.simple.thrillio.constants.Gender;
...
import com.simple.thrillio.util.IOUtil;
...
public class DataStore {
	...
	private static void loadBooks() {
		 ...
		 * bookmarks[1][4] = BookmarkManager.getInstance().createBook(4004,
	...
	private static void loadMovies() {
		 ...
		 * MovieGenre.CLASSICS, 8.2); bookmarks[2][2] =
		 ...
		 * MovieGenre.DOCUMENTARIES, 7.3); bookmarks[2][3] =
		 ...
		 * "Bill Prady" }, MovieGenre.TV_SHOWS, 8.7); bookmarks[2][4] =
		...
		for (String row : data) {
			String[] values = row.split("\t");
			bookmarks[2][colNum++] = BookmarkManager.getInstance().createMovie(Long.parseLong(values[0]), values[1],
